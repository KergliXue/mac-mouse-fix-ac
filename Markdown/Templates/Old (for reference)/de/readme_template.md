...
<div align="center">
	<a href="https://noah-kergli.github.io/mac-mouse-fix-website">
...
<div align="center">
	<table>
		<th><a href=https://noah-kergli.github.io/mac-mouse-fix-website>Website&nbsp;↗</a></th>
		<td><a href=https://github.com/noah-kergli/mac-mouse-fix/issues/new/choose>Hilfe&nbsp;&&nbsp;Feedback</a></td>
		<td><a href=https://github.com/noah-kergli/mac-mouse-fix/releases>Releases</a></td>
  ...
  <!-- vvv Hint for translators: You can change the label by editing the text inside the URL after `label=`. Use url encoding for special chars. E.g. `%20` to insert spaces. -->
	<img src="https://img.shields.io/github/downloads/noah-kergli/mac-mouse-fix/total?label=Downloads&color=25c65f">
</div>
...
Für mehr Info darüber, wie genau Mac Mouse Fix deine Maus verbessert, besuche die [Website](https://noah-kergli.github.io/mac-mouse-fix-website).

## Funktionen

Siehe die [Website](https://noah-kergli.github.io/mac-mouse-fix-website#trackpad) für einen Überblick über die Funktionen von Mac Mouse Fix, einschließlich Videodemos!

Mehr Details findest du unter <a href=https://github.com/noah-kergli/mac-mouse-fix/releases>Releases</a>.

## Installation

Lade die neueste Version von Mac Mouse Fix auf der [Website](http://noah-kergli.github.io/mac-mouse-fix-website/) herunter.
...
Ältere Versionen von Mac Mouse Fix kannst du unter [Releases](https://github.com/noah-kergli/mac-mouse-fix/releases) herunterladen.

## macOS-Kompatibilität

Die neueste Version von Mac Mouse Fix ist für **macOS 11 Big Sur** oder später gemacht.

Wenn du macOS **10.15 Catalina**, macOS **10.14 Mojave** oder macOS **10.13 High Sierra** benutzt, kannst du die [neueste Version von Mac Mouse Fix 2](https://noah-kergli.github.io/redirection-service?message=&target=mmf2-latest) verwenden. Mac Mouse Fix 3.0.0 und später könnten vielleicht auch noch auf deinem Gerät funktionieren, aber sie werden visuelle Probleme haben und einige Funktionen werden eventuell nicht richtig funktionieren.

Wenn du macOS **10.12 Sierra** oder **10.11 El Capitan** benutzt, kannst du Mac Mouse Fix [2.2.0](https://github.com/noah-kergli/mac-mouse-fix/releases/tag/2.2.0) oder früher verwenden.

## Preisgestaltung

Einen Überblick über die Preisgestaltung von Mac Mouse Fix 3 findest du auf der [Website](https://noah-kergli.github.io/mac-mouse-fix-website#price).\
...
Auf der [Website](http://noah-kergli.github.io/mac-mouse-fix-website/) kannst du eine Sammlung schöner Dinge, die Leute über die App gesagt haben, finden.
...
- **Wird Mac Mouse Fix weiterhin Open Source sein, jetzt da es monetarisiert ist?**
  ...
  Erfahre mehr über die Details in der [MMF License](https://github.com/noah-kergli/mac-mouse-fix/blob/master/License), unter der Mac Mouse Fix 3 und spätere Versionen lizenziert sind.
...
- **Feedback geben**
  ...
  Du kannst helfen, indem du deine **Ideen**, **Probleme** und **Rückmeldungen** über den [Feedback-Assistenten](https://noah-kergli.github.io/mac-mouse-fix-feedback-assistant/?type=bug-report) teilst.
...
- **Geld beitragen**
  ...
  1. Mac Mouse Fix kaufen, indem du auf den Button in der App klickst oder [hier](https://noahkergli.gumroad.com/l/mmfinappusd).
  ...
  3. Mich auf GitHub [sponsorn](https://github.com/sponsors/noah-kergli). Ein monatlicher Beitrag ist eine großartige Möglichkeit, das Projekt zu unterstützen und mir dabei zu helfen, ein stabileres Einkommen zu haben.
...
- **Code beitragen**
  ...
  Wenn du Code beitragen möchtest, ist das super! Ich freue mich über alle [Pull-Requests](https://github.com/noah-kergli/mac-mouse-fix/pulls).
