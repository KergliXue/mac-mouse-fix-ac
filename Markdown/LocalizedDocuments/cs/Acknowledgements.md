...
Tento dokument je přeložen do jazyka `90%`
...
Velké díky všem, kteří používají Mac Mouse Fix a poskytují zpětnou vazbu. Je úžasné a velmi motivující vidět, jak se tolik lidí baví a zapojuje se do něčeho, co jsem vytvořil.

Chci obzvláště poděkovat lidem a projektům uvedeným v tomto dokumentu.

<a name="translations"></a> 
## 🌏 Překlady

Děkujeme, že přinášíte Mac Mouse Fix lidem po celém světě!
...
- 🇰🇷 korejské překlady od [@jeongtae](https://github.com/jeongtae)
- 🇻🇳 vietnamské překlady od [@nghlt](https://github.com/nghlt)
...
Moc děkuji všem, kteří mi poslali milkšejk, a všem **32200+** lidem, kteří si koupili Mac Mouse Fix.
...
**Velké díky** všem, kteří mě sponzorují na GitHubu [komukoli](https://github.com/sponsors/noah-kergli#sponsors)! Doufám, že se mi jednou díky vám podaří tu továrnu na milkšejky získat. :)

<a name="paypal-donations"></a> 
### ✨ Dary přes PayPal

Spousta štědrých lidí mi koupila milkšejky přes PayPal, když byl Mac Mouse Fix ještě zcela zdarma.

Pokud mezi nimi patříte, klikněte [sem](https://redirect.macmousefix.com/?locale=cs&target=mmf-apply-for-milkshake-license) a získejte **bezplatnou licenci**!
<!-- It's truly incredibly helpful to have some predictable monthly income. -->

<a name="other-software"></a> 
## 👾 Další software

**Software**, který inspiroval Mac Mouse Fix:

- [SteerMouse](https://plentycom.jp/en/steermouse/index.html) - Průkopnický software pro myš pro Mac, inspirující mnoho funkcí. Byly chvíle, kdy jsem si myslel, že "to asi není možné", ale pak jsem viděl, že "aha, SteerMouse to dělá", a o tři roky později jsem také přišel na to, jak to implementovat.
- [Calftrail Touch](https://github.com/calftrail/Touch) - Základ pro "reverzní inženýrství", které pohání nejlepší a první simulaci trackpadu v Mac Mouse Fix!
- [MOS](https://mos.caldis.me/) - Možnost "Vysoká plynulost rolování" v Mac Mouse Fix, implementace "Nastavení specifická pro aplikaci" a další byly inspirovány MOS.
- [SensibleSideButtons](https://github.com/archagon/sensible-side-buttons) - Zkopíroval jsem jeho kód pro ranou implementaci funkce "Přejít zpět/vpřed o jednu stránku v Safari a dalších aplikacích" a také mě to vedlo k objevení projektu Calftrail Touch.
- [Gifski](https://github.com/sindresorhus/Gifski) - Významně inspiroval design a obsah souboru [Readme.md](Readme.md) pro opravu myši na Macu.
- [Pomocník pro řešení problémů s Vue](https://new-issue.vuejs.org/) - Základ pro návrh a technickou implementaci nástroje [Asistent pro zpětnou vazbu k opravě myši na Macu](https://noah-kergli.github.io/mac-mouse-fix-feedback-assistant/).
