...
Этот документ переведен на язык 🇷🇺 Русский с 90%.
...
Большое спасибо всем, кто использует Mac Mouse Fix и оставляет отзывы. Очень приятно и мотивирует видеть, что так много людей пользуются и ценят то, что я создал.

Особую благодарность я хочу выразить людям и проектам, упомянутым в этом документе.

<a name="translations"></a> 
## 🌏 Переводы

Спасибо за то, что вы сделали Mac Mouse Fix доступным для людей по всему миру!
...
- 🇰🇷 Корейский перевод: [@jeongtae](https://github.com/jeongtae)
- 🇻🇳 Перевод на вьетнамский язык: [@nghlt](https://github.com/nghlt)
- 🇧🇷 Перевод на бразильский португальский язык: **Эдуардо Родригес**
- 🇫🇷 Перевод на французский язык: [@DimitriDR](https://github.com/DimitriDR)
- 🇹🇷 Турецкий перевод: [@hasanbeder](https://github.com/hasanbeder)
- 🇨🇿 Чешский перевод: [Petr Pavlík](http://www.petrpavlik.com)
- 🇷🇺 Русский перевод: [ETMH](https://t.me/sos_soon_ok)

<!-- 
  Old stuff from Money section:

  Thanks so much to everyone who bought me a milkshake and to all 32200+ people who bought Mac Mouse Fix! Ya'll are the bomb. Thanks to you I can spend lots of time on sth I love doing.
...
Большое спасибо всем, кто угостил меня молочным коктейлем, и всем **32200+** людям, которые купили Mac Mouse Fix.
Благодаря вам я могу много времени посвящать тому, что люблю. 

Люди, которые поддержали меня, заплатив за Mac Mouse Fix больше стандартной цены, получают здесь особое упоминание:
...
**Огромное спасибо** [всем](https://github.com/sponsors/noah-kergli#sponsors), кто спонсирует меня на GitHub! Надеюсь, благодаря вам я когда-нибудь смогу купить фабрику по производству молочных коктейлей. :)

<a name="paypal-donations"></a> 
### ✨ Пожертвования через PayPal

Многие щедрые люди покупали мне молочные коктейли через PayPal, когда Mac Mouse Fix еще был полностью бесплатным.

Если вы один из них, нажмите [здесь](https://redirect.macmousefix.com/?locale=ru&target=mmf-apply-for-milkshake-license), чтобы получить **бесплатную лицензию**!
<!-- It's truly incredibly helpful to have some predictable monthly income. -->

<a name="other-software"></a> 
## 👾 Другое программное обеспечение

**Программное обеспечение**, которое вдохновило Mac Mouse Fix:

- [SteerMouse](https://plentycom.jp/en/steermouse/index.html) - новаторское программное обеспечение для мыши Mac, вдохновившее многие функции. Были моменты, когда я думал: "Это, наверное, невозможно", но потом я увидел: "О, SteerMouse это делает", и через три года я тоже понял, как это реализовать.
- [Calftrail Touch](https://github.com/calftrail/Touch) — основа для "обратного инжиниринга", который обеспечивает лучшую в своем классе и первую в своем роде симуляцию трекпада в Mac Mouse Fix!
- [MOS](https://mos.caldis.me/) - Опция "Высокая плавность прокрутки" Mac Mouse Fix, реализация "Настроек для конкретных приложений" и многое другое были вдохновлены MOS.
- [SensibleSideButtons](https://github.com/archagon/sensible-side-buttons) - Я скопировал его код для ранней реализации функции "Вернуться/перейти на одну страницу назад в Safari и других приложениях", а также это привело меня к открытию проекта Calftrail Touch.
- [Gifski](https://github.com/sindresorhus/Gifski) - Сильно вдохновил дизайн и содержание [Readme.md](Readme.md) для Mac Mouse Fix.
- [Vue Issue Helper](https://new-issue.vuejs.org/) - Основа для дизайна и технической реализации [Mac Mouse Fix Feedback Assistant](https://noah-kergli.github.io/mac-mouse-fix-feedback-assistant/).
