...
<div align="center">
    <table>
        ...
        <td><a href=https://redirect.macmousefix.com/?locale=de&target=mmf-help-and-feedback>Hilfe&nbsp;&amp;&nbsp;Feedback</a></td> <!-- Note: Should probably use direct link instead of redirection-service: https://github.com/noah-kergli/mac-mouse-fix/issues/new/choose -->
        <td><a href=https://redirect.macmousefix.com/?locale=de&target=mmf-releases>Releases</a></td> <!-- Note: Should probably use direct link instead of redirection-service: https://github.com/noah-kergli/mac-mouse-fix/releases -->
...
Mehr Details findest du unter [Releases](https://github.com/noah-kergli/mac-mouse-fix/releases).
...
- **Kann ich Mac Mouse Fix kostenlos bekommen, wenn ich bereits gespendet habe?**
  ...
  Ja! Wenn du via PayPal gespendet hast, klicke [hier](https://redirect.macmousefix.com/?locale=de&target=mmf-apply-for-milkshake-license) um eine **kostenlose Lizenz** zu erhalten.
...
- **Übersetzungen hinzufügen**
  ...
  Wenn du **beim Übersetzen des Projekts helfen** möchtest, sieh dir das [Translation Guide](https://redirect.macmousefix.com/?target=mmf-localization-contribution) an.<br>
