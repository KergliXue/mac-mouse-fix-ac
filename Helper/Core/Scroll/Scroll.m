...
///     See this note on the issue: https://github.com/noah-kergli/notes-public/blob/23361f16a315f48f1f6278161b8cefab50fc3665/mmf/bug-investigation/scrolling-stops-intermittently_apr-2025.md
///
...
+ (void)load_Manual {
    ...
    _scrollQueue = dispatch_queue_create("com.kergli.mac-mouse-fix.helper.scroll", attr);
...
static void heavyProcessing(CGEventRef event, int64_t scrollDeltaAxis1, int64_t scrollDeltaAxis2, CFTimeInterval tickTS) {
    ...
    if (runningPreRelease()) { /// if-statement because hidEvent.description is very slow
        ...
        if (sendingDev != NULL) {
            ...
            ///     Thread: Thread 3 (Dispatch queue: com.kergli.mac-mouse-fix.helper.scroll)
...
//                tick = _scrollConfig.consecutiveScrollTickIntervalMax + 1.0;
                ...
                ///
                /// Notes:
                /// - Asserting this apparently caused the crash in 3.0.2 from https://github.com/noah-kergli/mac-mouse-fix/issues/988
                ...
                /// - One other idea is that the lower framerates in 3.0.2 could have indirectly caused problems somehowww, but one user also said the crashes didn't coincide with their computer being slow, so idk. (In this GH comment: https://github.com/noah-kergli/mac-mouse-fix/issues/988#issuecomment-2187647181)
