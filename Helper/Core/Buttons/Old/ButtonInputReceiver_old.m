...
///
/// This is the `old` ButtonInputReceiver because afterwards we remove the `_buttonInputsFromRelevantDevices` which was already unused in favour of looking at CGEventField 87 to get the sending device. 
///
...
static CGEventRef eventTapCallback(CGEventTapProxy proxy, CGEventType type, CGEventRef event, void *userInfo) {
    ...
    /// - Why switch away from old method? - Under Ventura I think the HID callback API broke for some devices. See https://github.com/noah-kergli/mac-mouse-fix/issues/424. I remember similar bugs in the API in older macOS versions a few years back.
