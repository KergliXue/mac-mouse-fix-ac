...
@interface NSDictionary<KeyType, ObjectType> (UndeprecateSimpleUnboxing)
...
@interface NSArray<ObjectType> (UndeprecateSimpleUnboxing)
...
@interface NSString (UndeprecateSimpleUnboxing)
...
@interface NSData (UndeprecateSimpleUnboxing)
