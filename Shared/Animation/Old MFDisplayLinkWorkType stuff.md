...
# `displayLinkCallback()` function
    ...
    static CVReturn displayLinkCallback(CVDisplayLinkRef displayLink, const CVTimeStamp *inNow, const CVTimeStamp *inOutputTime, CVOptionFlags flagsIn, CVOptionFlags *flagsOut, void *displayLinkContext) {
        ...
        if (self->_optimizedWorkType == kMFDisplayLinkWorkTypeGraphicsRendering) {
            ...
            ///     - See this GH Issue by V-Coba: https://github.com/noah-kergli/mac-mouse-fix/issues/875
            ...
            ///             - See this comment for further discussion of this decisin: https://github.com/noah-kergli/mac-mouse-fix/issues/875#issuecomment-2016869451
            ///         -> Maybe later, we can explore trying to analyze the CVDisplayLinkThread of the scrolled app in order to improve scheduling. That's the best idea I have right now. See https://github.com/noah-kergli/mac-mouse-fix/issues/875#issuecomment-1986811798 for more info and potential libraries we could use to achieve this.
            /// 
            ...
            if (workDelay <= 0) {
                ...
                DDLogError(@"DisplayLink.m: (%@) Don't use special scheduling without extensive testing. This caused regressions in scrolling stutteriness in some scenarios and even crashes I think (See 3.0.2-vcoba stuff: https://github.com/noah-kergli/mac-mouse-fix/issues/875, and 3.0.2 crashes: https://github.com/noah-kergli/mac-mouse-fix/issues/988)", [self identifier]);
                assert(false);
...
# Shared memory methods
    ...
    - (CVReturn)mapInSharedMemoryForDisplay:(CGDirectDisplayID)displayID {
        ...
        ///     - I'm pretty sure I have not found a way to access the framebuffer but I'm not 100% sure. It's been over a month between writing the code and writing these comments. Also see this GitHub comment I wrote as evidence that I haven't found a way: https://github.com/noah-kergli/mac-mouse-fix/issues/875#issuecomment-1986394616
