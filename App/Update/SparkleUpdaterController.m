...
- (SUAppcastItem *)bestValidUpdateInAppcast:(SUAppcast *)appcast forUpdater:(SUUpdater *)updater {
    ...
    /// Discussion:
    /// - Discussion/brainstorming for custom logic: https://github.com/noah-kergli/mac-mouse-fix/issues/962#issuecomment-2120238813
    ...
    /// - The original design for our`bestValidUpdateInAppcast:` logic (which I more or less outlined [here](https://github.com/noah-kergli/mac-mouse-fix/issues/962#issuecomment-2120238813) and which was implemented in older commits) was implemented in a more complicated way, but should behave mostly the same. The problems that made me think of this new solution, and which this new solution fixes is this:
